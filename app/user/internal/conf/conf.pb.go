...
const file_app_user_internal_conf_conf_proto_rawDesc = "" +
	...
	"\aTracing\x12<\n" +
	"\x06jaeger\x18\x01 \x01(\v2$.kratos.api.user.conf.Tracing.JaegerR\x06jaeger\x12\x1f\n" +
...
var file_app_user_internal_conf_conf_proto_goTypes = []any{
	...
	(*Tracing_Jaeger)(nil),  // 11: kratos.api.user.conf.Tracing.Jaeger
}
var file_app_user_internal_conf_conf_proto_depIdxs = []int32{
	...
	11, // 10: kratos.api.user.conf.Tracing.jaeger:type_name -> kratos.api.user.conf.Tracing.Jaeger
