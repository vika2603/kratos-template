...
const file_app_user_internal_conf_conf_proto_rawDesc = "" +
	...
	"\x04auth\x18\x03 \x01(\v2\x1a.kratos.api.user.conf.AuthR\x04auth\"\xef\x01\n" +
	"\x06Server\x125\n" +
	"\x04grpc\x18\x01 \x01(\v2!.kratos.api.user.conf.Server.GRPCR\x04grpc\x12>\n" +
	"\ametrics\x18\x02 \x01(\v2$.kratos.api.user.conf.Server.MetricsR\ametrics\x1aO\n" +
	"\x04GRPC\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x1a\x1d\n" +
	"\aMetrics\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\"\xff\x01\n" +
	"\x04Data\x12?\n" +
...
var file_app_user_internal_conf_conf_proto_goTypes = []any{
	...
	(*Server_Metrics)(nil),      // 5: kratos.api.user.conf.Server.Metrics
	(*Data_Database)(nil),       // 6: kratos.api.user.conf.Data.Database
...
var file_app_user_internal_conf_conf_proto_depIdxs = []int32{
	...
	5, // 4: kratos.api.user.conf.Server.metrics:type_name -> kratos.api.user.conf.Server.Metrics
	6, // 5: kratos.api.user.conf.Data.database:type_name -> kratos.api.user.conf.Data.Database
	7, // 6: kratos.api.user.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	7, // 7: kratos.api.user.conf.Data.Database.conn_max_lifetime:type_name -> google.protobuf.Duration
